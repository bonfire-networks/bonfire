defmodule Iconify.Noto.BaguetteBread do
  ...
  def render(assigns) do
    ...
    >
      ...
      >
        <stop offset=".445" stop-color="#DB8316"></stop>
        <stop offset=".539" stop-color="#DF8A1B"></stop>
        <stop offset=".671" stop-color="#E99C2A"></stop>
        <stop offset=".79" stop-color="#F6B23B"></stop>
      </radialgradient>
      <path
        fill="url(#svgIDa)"
      ...
      >
        ...
        <stop offset="1" stop-color="#FBD8A9" stop-opacity="0"></stop>
      </radialgradient>
      <path
        fill="url(#svgIDb)"
      ...
      >
        ...
        <stop offset=".37" stop-color="#FCE1B9" stop-opacity=".742"></stop>
        <stop offset=".716" stop-color="#FAD8A9" stop-opacity=".416"></stop>
        <stop offset=".843" stop-color="#FCE0B6" stop-opacity=".211"></stop>
        <stop offset=".974" stop-color="#FDE5BF" stop-opacity="0"></stop>
      </radialgradient>
      <path
        fill="url(#svgIDc)"
      ...
      >
        ...
        <stop offset=".977" stop-color="#FBD8A9" stop-opacity="0"></stop>
      </radialgradient>
      <path
        fill="url(#svgIDd)"
      ...
      >
        ...
        <stop offset="1" stop-color="#FDE5BF" stop-opacity="0"></stop>
      </radialgradient>
      <path
        fill="url(#svgIDe)"
